...
function selectRandom(array) {
    let elementIndex = Math.floor(Math.random() * array.length);
    return array[elementIndex];
}

function pickMystery() {
    let suspectName = selectRandom(suspectsArray);
    let roomName = selectRandom(roomsArray);
    let weaponName = selectRandom(weaponsArray);
    let mystery = {
        suspect: suspectName,
        room: roomName,
        weapon: weaponName
